# This is the same as what a views.py file would be
# This tutorial just names it as a routes.py file
# render_template to view the pages, flash to show the error messages, redirect for redirect urls, url_for for relative links and request for
...
#implmementing the login function!
...
def login():
    ...
    # form = form is just using the above form as an object for the renderer value named form
    #return render_template('login.html', title='Sign In', form=form)
